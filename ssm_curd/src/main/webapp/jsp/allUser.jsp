...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 column">
            ...
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/user/updateUser.do">修改</a>
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/user/toAddUser.do">删除</a>
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/user/toAddUser.do">查询</a>
